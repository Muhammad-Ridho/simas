...
class DepartmentController extends Controller {
    ...
    public function store(Request $request, ) {
        ...
        $request->validate(["name" => "required", "keterangan" => "required"]);
    ...
    public function update(Request $request, Department $department,) {
		...
		$department->keterangan = $request->keterangan;
            ...
            return redirect()->route('admin.departments.index', [])->with('success', __('Department edited successfully.'));
        } catch (\Throwable $e) {
            return redirect()->route('admin.departments.edit', compact('department'))->withInput($request->input())->withErrors(['error' => $e->getMessage()]);
        }
    }
